...
class Alertfechasestadisticas extends StatefulWidget {
  final Function(DateTime?, DateTime?) seleccionRango;
  final String titulo;
  final String contenido;

  Alertfechasestadisticas({
    super.key,
...
class _AlertFechasState extends State<Alertfechasestadisticas> {
      ...
      content: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(children: [campoInicial(), campoFinal()]),
          ),
        ],
      ),
      actions: [
        ...
        TextButton(
          onPressed: () {
            ...
            widget.seleccionRango(null, null);
            Navigator.of(context).pop();
          },
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text(
                '¿Está seguro de generar estadisticas en estos valores?',
